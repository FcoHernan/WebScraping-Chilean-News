		...
		$thumb_h        = $instance['thumb_h'];
			...
			<p>
				<label for="<?php echo $this->get_field_id("num"); ?>">
					<?php _e('Number of posts to show', 'bloggr'); ?>:
				...
				<label for="<?php echo $this->get_field_id("asc_sort_order"); ?>">
					<input type="checkbox" class="checkbox" 
					  ...
					  <?php checked( (bool) $instance["asc_sort_order"], true ); ?> />
							<?php _e( 'Reverse sort order (ascending)', 'bloggr' ); ?>
				</label>
			</p>
			...
			<p>
				<label for="<?php echo $this->get_field_id("title_link"); ?>">
					...
					<?php _e( 'Make widget title link', 'bloggr' ); ?>
				</label>
			</p>
			...
			<p>
				<label for="<?php echo $this->get_field_id("excerpt"); ?>">
					...
					<?php _e( 'Show post excerpt', 'bloggr' ); ?>
				</label>
			</p>
			
			<p>
				<label for="<?php echo $this->get_field_id("excerpt_length"); ?>">
					<?php _e( 'Excerpt length (in words):', 'bloggr' ); ?>
				</label>
			...
			<p>
				<label for="<?php echo $this->get_field_id("comment_num"); ?>">
					...
					<?php _e( 'Show number of comments', 'bloggr' ); ?>
				</label>
			</p>
			...
			<p>
				<label for="<?php echo $this->get_field_id("thumb"); ?>">
					...
					<?php _e( 'Show post thumbnail', 'bloggr' ); ?>
				</label>
			</p> 
			<p>
				<label>
					<?php _e('Thumbnail dimensions (in pixels)', 'bloggr'); ?>:<br /> 
