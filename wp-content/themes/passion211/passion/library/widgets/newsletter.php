...
class KopaNewsletter extends KopaWidget {
	...
	public function widget( $args, $instance ) {
		...
		if ( $uri ) {
			?>
			<form class="newsletter-form clearfix" action="http://feedburner.google.com/fb/a/mailverify" method="post" target="popupwindow" onsubmit="window.open('http://feedburner.google.com/fb/a/mailverify?uri=<?php echo esc_url( $uri ); ?>', 'popupwindow', 'scrollbars=yes,width=550,height=520');
			        return true;">        
				<?php
