                        ...
                        <article class="entry-item clearfix">
                            ...
                            <div class="entry-content">
                                ...
                                <?php if ('true' != $instance['is_hide_readmore']): ?>
                                    <a class="more-link clearfix" href="<?php echo esc_url($post_url); ?>">
                                        <?php echo KopaIcon::getIcon('fa fa-link entry-icon', 'span'); ?><span><?php _e('Read more ...', kopa_get_domain()); ?></span>
                                    </a>
                                <?php endif; ?>
                            </div>
                            <!-- entry-content -->
