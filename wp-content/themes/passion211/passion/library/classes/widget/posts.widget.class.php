...
class KopaWidgetPosts extends KopaWidget {
    ...
    public function __construct($id_base, $name, $widget_options = array(), $control_options = array()) {
        ...
        $col1['fields']['posts_per_page'] = array(
            'type' => 'number',
            'id' => 'posts_per_page',
            'name' => 'posts_per_page',
            'default' => 4,
        ...
        $col1['fields']['excerpt_character_limit'] = array(
            'type' => 'number',
        ...
        $col1['fields']['is_hide_title'] = array(
            'type' => 'checkbox',
            'id' => 'is_hide_title',
            'name' => 'is_hide_title',
            'default' => 'false',
        ...
        $col1['fields']['is_hide_created_date'] = array(
            'type' => 'checkbox',
        ...
        $col1['fields']['is_hide_comments'] = array(
            'type' => 'checkbox',
            'id' => 'is_hide_comments',
        ...
        $col1['fields']['is_hide_views'] = array(
            'type' => 'checkbox',
            'id' => 'is_hide_views',
            'name' => 'is_hide_views',
            'default' => 'false',
        ...
        $col1['fields']['is_hide_excerpt'] = array(
            'type' => 'checkbox',
            'id' => 'is_hide_excerpt',
        ...
        $col1['fields']['is_hide_readmore'] = array(
            'type' => 'checkbox',
            'id' => 'is_hide_readmore',
        ...
        $this->groups['col-1'] = $col1;
        $this->groups['col-2'] = $col2;
    }
