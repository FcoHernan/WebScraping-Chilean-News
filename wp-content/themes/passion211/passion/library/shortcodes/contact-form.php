...
function kopa_shortcode_contact_form($atts, $content = null) {
    ...
    if ($description || $mail || $phone || $fax || $address) {
        ...
        if ($mail || $phone || $fax || $address) {
            ...
            if ($mail)
                $content .= sprintf('<p class="kopa-contact-info"><span>%3$s<span>%1$s</span></span><a href="mailto:%2$s">%2$s</a></p>', __('Email', kopa_get_domain()), $mail, KopaIcon::getIcon('fa fa-envelope-o'));

            if ($phone)
                $content .= sprintf('<p class="kopa-contact-info"><span>%3$s<span>%1$s</span></span><a href="tel:%2$s">%2$s</a></p>', __('Phone', kopa_get_domain()), $phone, KopaIcon::getIcon('fa fa-phone'));

            if ($fax)
                $content .= sprintf('<p class="kopa-contact-info"><span>%3$s<span>%1$s</span></span>%2$s</p>', __('Fax', kopa_get_domain()), $fax, KopaIcon::getIcon('fa fa-print'));

            if ($address)
                $content .= sprintf('<p class="kopa-contact-info"><span>%3$s<span>%1$s</span></span>%2$s</p>', __('Address', kopa_get_domain()), $address, KopaIcon::getIcon('fa fa-map-marker'));
