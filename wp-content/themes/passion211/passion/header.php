...
<html <?php language_attributes(); ?>>              
    ...
    <body <?php body_class(); ?>>  
        <div class="wrapper">
			<?php do_action( 'passion_top_of_site' ); ?>
					...
					if ( $top_banner_image || $top_banner_code ):
						...
						<div id="top-banner" class="pull-right">
							...
							<?php elseif ( $top_banner_image ): ?>
								...
								<a <?php echo esc_html( $top_banner_target ); ?> href="<?php echo KopaOptions::get_option( 'top_banner_url' ); ?>"><img src="<?php echo do_shortcode( $top_banner_image ); ?>" alt=""/></a>
							<?php endif; ?>
						</div>
					<?php endif; ?>
                    <div class="clear"></div>
