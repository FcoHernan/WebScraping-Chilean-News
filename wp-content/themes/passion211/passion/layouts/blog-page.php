                        ...
                        <article class="entry-item clearfix">
                            <header>
                                ...
                                <?php if ('true' == $is_display_comments): ?>
                                    <span class="entry-comments clearfix"><?php echo KopaIcon::getIcon('fa fa-comment-o entry-icon', 'span'); ?><?php comments_popup_link(__('No Comment', kopa_get_domain()), __('1 Comment', kopa_get_domain()), __('% Comments', kopa_get_domain()), 'entry-comment', __('Comment Off', kopa_get_domain())); ?></span>                                                                                                                       
                                <?php endif; ?>
                                    ...
                                    if (in_array($post_format, array('video', 'gallery', 'audio'))) {
                                        ...
                                        if (!empty($shortcode)) {
                                            ...
                                            <div class="entry-thumb">
                                                <a href="<?php echo esc_url($post_url); ?>"><img src="<?php echo esc_url($image_croped); ?>" alt="" /></a>                                
                                            </div>
                                            <?php
                                        }
                                    } else {
                            ...
                            <div class="entry-content">
                                ...
                                <a href="<?php echo esc_url($post_url); ?>" class="more-link clearfix"><?php echo KopaIcon::getIcon('fa fa-link entry-icon', 'span'); ?><span><?php _e('Read more ...', kopa_get_domain()); ?></span></a>
                            </div>
                            <!-- entry-content -->
                        </article>
                        <!-- entry-item -->
