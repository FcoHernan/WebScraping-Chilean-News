...
function kopa_comment_form( $args = array(), $post_id = null ) {
	...
	$defaults['comment_field'] = (is_user_logged_in()) ? '<div class="clearfix">' : '<div class="comment-right pull-left">';
	...
	<?php if ( comments_open( $post_id ) ) : ?>
		...
		<div id="respond" class="comment-respond">  
			...
			<p><?php echo wp_kses_post( $args['comment_notes_before'] ); ?></p>
		...
		<article class="comment-wrap clearfix"> 
			...
			<div class="comment-body clearfix">
				<header class="clearfix">                                
					...
					<span class="entry-date clearfix"><?php echo KopaIcon::getIcon( 'fa fa-calendar-o entry-icon', 'span' ); ?><span><?php comment_time( get_option( 'date_format' ) . ' - ' . get_option( 'time_format' ) ); ?></span></span>
